...
const STATES = ["TX", "CA", "NY", "FL", "WA", "IL", "MA", "CO", "GA", "AZ", "NC", "OH"];
  ...
  const shippingCost =
    shipping === "express"
      ...
      : sub >= FREE_SHIP_THRESHOLD
        ? 0
        : STANDARD_BELOW_THRESHOLD;
  const standardLabel =
    sub >= FREE_SHIP_THRESHOLD ? "Free" : `$${STANDARD_BELOW_THRESHOLD.toFixed(2)}`;
        ...
        <div className="v3chk-layout">
                  ...
                  <div className="v3chk-pay-panel">
                    ...
                    {sdkReady === "failed" && (
                      <p role="alert" className="v3chk-error" style={{ margin: "0 0 12px" }}>
                        ...
                        we&rsquo;ll complete your order.
                      </p>
                    )}
                    ...
                    <Field label="Card number">
                      ...
                      {hfErrors.cardNumber && (
                        <div className="v3chk-hf-error">{hfErrors.cardNumber}</div>
                      )}
                    </Field>
                    ...
                    <div className="v3chk-security-note">
                      Card details are entered in PCI-DSS secure fields hosted by Bankful and
                      tokenized in your browser. PurePep never sees or stores your full card number
                      or CVV.
                    </div>
          ...
          <aside className="v3chk-col-aside">
                ...
                <div>
                  ...
                  {promoApplied ? (
                    <div className="v3chk-order-row v3chk-promo-applied">
                      ...
                      <span className="v3chk-order-v v3chk-promo-savings">
            ...
            <div className={clsx("v3chk-compliance", complianceChecked && "is-confirmed")}>
              <label
                className={clsx("v3chk-compliance-label", complianceChecked && "is-confirmed")}
              >
                <input
                  type="checkbox"
                ...
                <span className="v3chk-compliance-text">
                  I confirm I am a <strong>qualified researcher aged 21+</strong> and that these
                  products will be used <strong>strictly for in vitro laboratory research</strong>.
            ...
            <div className="v3chk-place-note">
              ...
              <a href="/terms-of-service">Terms of Sale</a>,{" "}
              <a href="/privacy-policy">Privacy Policy</a>, and{" "}
              <a href="/refund-policy">Refund Policy</a>. Your card will be charged{" "}
              <span className="v3chk-place-charge">${total.toFixed(2)}</span>, shown on your
            ...
            <div className="v3chk-dispute-note">
              ...
              resolved within one business day. Unauthorized chargebacks on completed
              research-material orders may be contested with order, tracking, and delivery records.
            </div>
