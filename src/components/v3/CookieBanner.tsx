      ...
      <div className="mx-auto flex max-w-[1280px] flex-col items-start gap-3 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:gap-6 sm:px-8">
        ...
        <div className="flex flex-shrink-0 items-center gap-3">
          <button
            ...
            className="inline-flex h-10 cursor-pointer items-center justify-center rounded-full border border-ink/20 bg-transparent px-5 text-[13px] font-medium text-ink transition-colors hover:bg-surface-2"
          >
            Decline
          </button>
          <button
