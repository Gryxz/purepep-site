...
const SUPPORT_LINKS =
  ...
  `<a href="tel:${ENTITY.phoneTel}">${ENTITY.phoneDisplay}</a> · ` +
...
export const LEGAL_FALLBACKS: Record<string, PolicyFallback> = {
  "refund-policy": {
    ...
    contentHtml: `
      ...
      <p>Before initiating a chargeback or bank dispute, contact us first through ${SUPPORT_LINKS}. Most issues are resolved within one business day.</p>
      <p>All ${ENTITY.brand} orders include tracking and delivery confirmation. Unauthorized chargebacks on completed research-material orders may be contested using order records, tracking numbers, and carrier delivery proof. Issuing a chargeback does not entitle the buyer to retain the product.</p>
  ...
  "terms-of-service": {
    ...
    contentHtml: `
      <p>By purchasing from ${ENTITY.brand} you confirm you are a qualified researcher aged 21 or older, and that any product purchased will be used exclusively for in vitro laboratory research.</p>

      <h2>Eligibility</h2>
      <p>${compliance.qualified21} ${ENTITY.brand} verifies researcher eligibility at checkout where required. You agree to provide accurate information at checkout and not to resell, redistribute, or transfer product to any party for human or veterinary application.</p>

      <h2>Product use</h2>
      <p>${compliance.researchUseOnly} ${ENTITY.brand} products are not approved by the FDA or any other regulatory body for human or veterinary use, and are not intended to diagnose, treat, cure, or prevent any disease. Use in humans, food, or supplements is strictly prohibited.</p>
      ...
      <p>All site content — text, photography, labels, and analytical methods documentation — is the property of ${ENTITY.brand}. Reproduction without written permission is prohibited.</p>
      ...
      <p>${ENTITY.brand} · ${ENTITY.address.full}</p>
  ...
  "privacy-policy": {
    ...
    contentHtml: `
      <p>This Privacy Policy describes how ${ENTITY.brand} collects, uses, and shares information when you visit purepep.shop or place an order.</p>
      ...
      <p>We do not sell your information. We share order details with shipping carriers, payment processors, and qualified service providers strictly as needed to fulfill your order. We may disclose information when required by law or to protect the rights and safety of ${ENTITY.brand}, our researchers, or the public.</p>
  ...
  "shipping-policy": {
    ...
    contentHtml: `
      <p>${ENTITY.brand} ships within the United States only. Every order ships with a lot-matched Certificate of Analysis.</p>
  ...
  disclaimer: {
    ...
    contentHtml: `
      ...
      <p>All products sold by ${ENTITY.brand} are intended exclusively for in vitro laboratory research by qualified researchers. They are not drugs, food, or supplements, and they have not been approved by the FDA or any other regulatory body for human or veterinary use.</p>
      ...
      <p>You may not use ${ENTITY.brand} products for human consumption, human application, veterinary application, or in any food or supplement. You may not resell, redistribute, or transfer product to any party for those purposes.</p>
      ...
      <p>${ENTITY.brand} makes no claims that any product diagnoses, treats, cures, or prevents any disease, condition, or symptom.</p>
  ...
  contact: {
    title: "Contact",
    contentHtml: `
      <p>Reach the ${ENTITY.brand} research team through ${SUPPORT_LINKS}.</p>
  ...
  faq: {
    title: "FAQ",
    contentHtml: `
      <p>Answers to common questions about ${ENTITY.brand} products, ordering, and research-use requirements.</p>

      <h2>What does "for research use only" mean?</h2>
      <p>${compliance.researchUseOnly} ${ENTITY.brand} peptides are not approved by the FDA or any other regulatory body for human or veterinary use. They are not drugs, food, or dietary supplements, and they may not be used in humans, animals, or any application outside a qualified laboratory research context.</p>

      <h2>Who may purchase?</h2>
      <p>${compliance.qualified21} By completing a purchase you confirm you are a qualified researcher aged 21 or older and that any product will be used exclusively for in vitro laboratory research. ${ENTITY.brand} reserves the right to refuse or cancel any order that does not meet these eligibility requirements.</p>

      <h2>How are products shipped and how long does delivery take?</h2>
      <p>${ENTITY.brand} ships within the United States only via standard tracked shipping. Most US addresses receive their order within 2–3 business days after dispatch. Orders placed before 12:00 ET Monday through Friday ship the same business day; orders placed later ship the next business day. A tracking number is emailed once the carrier collects the package.</p>
      ...
      <p>Bacteriostatic water is sold separately as an add-on item at checkout. It is not included by default. ${ENTITY.brand} recommends using sterile bacteriostatic water (0.9% benzyl alcohol) for reconstitution of all lyophilized peptide vials.</p>

      <h2>How can I reach support?</h2>
      <p>Contact the ${ENTITY.brand} research team through ${SUPPORT_LINKS}. Support hours are Mon–Fri 9 AM–5 PM ET. Replies are sent within one business day. For order and lot inquiries, quote your order number for the fastest resolution.</p>
    `.trim(),
  },
};
